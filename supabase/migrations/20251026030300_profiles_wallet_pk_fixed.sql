...
-- ============================================================================
-- Maneja las foreign keys de user_badges y follows correctamente
-- ============================================================================

-- PASO 1: Eliminar policies antiguas
...
-- PASO 3: Renombrar columnas en tablas dependientes (id -> wallet_address)
